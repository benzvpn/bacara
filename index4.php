...
<!-- 
                     <div style="margin-top:5px" class="fb-login-button" data-width="200" data-size="medium" data-button-type="login_with" data-auto-logout-link="false" data-use-continue-as="false"></div>
                          ...
                          <div style="margin-top:5px">
                           <fb:login-button  size="medium" width="200" scope="public_profile,email" onlogin="checkLoginState();">เข้าสู่ระบบด้วย Facebook
                          </fb:login-button>
                           </div> 

                           <input id="clickMe" type="button" value="clickme" onclick="checkLoginState();" />
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="register-verify.php" onsubmit="return checkReqFields()">
         ...
         <input id ="username-register" class="form-control" name="facebook" id="facebook" type="hidden" placeholder="ไอดีเข้าสู่ระบบ">

       <input id ="username-register" class="form-control" name="facebook_picture" id="facebook_picture" type="hidden" placeholder="ไอดีเข้าสู่ระบบ">

          <input id ="username-register" class="form-control" name="username" id="username" placeholder="ไอดีเข้าสู่ระบบ">
          <span id="alert-username-register"></span>

          <input id ="email-register" class="form-control" name="email" id="email" type="email" placeholder="อีเมล์">
          ...
          <input class="form-control" name="nickname" placeholder="ชื่อที่ใช้ในระบบ">
