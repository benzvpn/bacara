  ...
  var startApp = function() {
    gapi.load('auth2', function(){
      ...
      auth2 = gapi.auth2.init({
        client_id: '948989893595-bcbuipg8k26s5djlrt7nkikqs40ov87o.apps.googleusercontent.com',
    ...
    auth2.attachClickHandler(element, {},
        function(googleUser) {
          ...
          //     googleUser.getBasicProfile().getName();
                      ...
                      window.gID = googleUser.getBasicProfile().getId();
                      window.gName = googleUser.getBasicProfile().getName();
                      window.gEmail = googleUser.getBasicProfile().getEmail();
                      window.gImage = googleUser.getBasicProfile().getImageUrl();
        ...
        <div class="row" >
          <div class="col-12 col-sm-12">
                ...
                <?php
                 ...
                 {
                   ?>
                   <form action="logout2.php" class="login-form after-login blockstyle">
                    ...
                    ?> วัน </b></label><br/>
                      ...
                      <button type="submit" class="btn-submit btn-gold"><span>ออกจากระบบ</span></button>
                   ...
                   <form action="login_user.php" method ="post" id="fm_login" class="login-form blockstyle">
                    <div class="container">
                      ...
                      <div style="margin-top:5px;">
                        <div class="g-signin2" id="google_signin" data-onsuccess="onSignIn" data-width="100%" data-height="35" data-longtitle="true" data-theme="dark"></div>
                        </div>

                <!--           <div style="margin-top:5px;">
                        <a class="btn btn-block btn-social btn-google g-signin2" data-longtitle="true" id="btnGoogle" data-width="100%" data-height="35">
...
<!-- include('./manually_update_credit.php'); -->
      ...
      <div class="col-12 col-lg-3">
       <div class="row" >
          ...
          <div class="col-12 col-sm-12">
            <div class="show-line blockstyle">
              <div class="blockblock">
                <?php
                if ($_SESSION["line_img"] == "") {
                  echo '<img id="show-linead" src="src/images/line-ad.png">';
                } else {
                ?>
                <img id="show-linead" src="src/images/userline/<?php echo $_SESSION["line_img"]?>">
                <?php
                }
                ?>
              </div>
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form method="post" action="update_user.php" enctype="multipart/form-data">
          ...
          <div class="block-update-user-img">
            <?php
            if ($_SESSION["profile_img"] == "") {
            ...
            ?>
            <input id="profile-img" class="form-control" name="img_user" type="file" placeholder="แก้ไขภาพประจำตัว">
            <label for="profile-img">เลือกรูปภาพประจำตัว</label>
           <!--  <img src="" id="profile-img-tag" width="200px" /> -->
          </div>
          <div class="block-update-user-line">
            <?php
            if ($_SESSION["line_img"] == "") {
              echo '<img id="profile-line-tag" src="src/images/line-ad.png">';
            } else {
              ?>
              <img id="profile-line-tag" src="src/images/userline/<?php echo $_SESSION["line_img"]?>">
              <?php

            }
            ?>
            <input id="profile-line" class="form-control" name="line_user" type="file" placeholder="แก้ไขภาพประจำตัว">
            <label for="profile-line">เลือกรูปภาพไลน์@</label>

          </div>

          <input class="form-control" name="nickname" placeholder="ชื่อเล่นที่คุณใช้ : <?php
                      if ($_SESSION["nickname"] == "") {
                        echo $_SESSION["username"];
                      } else {
                        echo $_SESSION["nickname"];
          ...
          <input id="update-user-submit" class="btn btn-primary" type="submit" name="submit" value="Update">
        </form>
      </div>
...
<script type="text/javascript">
    ...
    function readUrlLine(input) {
        if (input.files && input.files[0]) {
            ...
            reader.onload = function (e) {
                $('#profile-line-tag').attr('src', e.target.result);
            }
            reader.readAsDataURL(input.files[0]);
        }
    }
...
<script type="text/javascript">
  ...
  responsive: [
    ...
    <script>
      ...
      //function signOut() {
       // document.location.href = "https://www.google.com/accounts/Logout?continue=https://appengine.google.com/_ah/logout?continue=https://underfox.xyz/ufabet/index.php";
      ...
      //}
       ...
       function signOut() {
        ...
        // auth2.signOut().then(function () {
        //     auth2.disconnect();
        //     document.location.href = "logout2.php";
        // });
