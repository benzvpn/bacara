    ...
    <div class="row">
      <div class="col-12 col-lg-3">
        <div class="row" >
          ...
          <div class="id"  data-theme="dark"></div>
          <div class="name"  data-theme="dark"></div>
          <div class="GivenName"  data-theme="dark"></div>
          <div class="FamilyName" data-theme="dark"></div>
          <div class="ImageUrl"  data-theme="dark"></div> 
          <div class="Email" data-theme="dark"></div>
...
function onSignIn(googleUser) 
{
  ...
  var id_member = "<?= $id_member ?>";
        ...
        $(".GivenName").text(profile.getGivenName());
        $(".FamilyName").text(profile.getFamilyName());
        $(".ImageUrl").text(profile.getImageUrl());
        $(".Email").text(profile.getEmail());

  $.ajax({
          url:"https://underfox.xyz/ufabet/webservice/facebook_login.php?id="+idgoogle,
          type:"POST",
          data:{ id:idgoogle },
          success : function(data)
          {
            if(data == 1)
            {
              ...
              {
                alert("เข้าสู่ระบบ");
                $('#login_username').val(profile.getId());
                $('#login_facebook').val("true");
                $("#fm_login").submit();
              }
            }
            else
            {
              ...
              $('#facebook_picture').val(img).prop('readonly', true);
              $('#username').val(idgoogle).prop('readonly', true);
